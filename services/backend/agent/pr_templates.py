...
BREAKING_A = PRTemplate(
    ...
    sections=[
        {"heading": "事件概述", "guide": "2-3句概述事件基本信息：时间、涉及方、事件性质、影响范围，让读者快速了解事件全貌"},
        {
            "heading": "技术解读",
...
BREAKING_B = PRTemplate(
    ...
    sections=[
        {"heading": "事件还原", "guide": "详细还原事件经过，包括时间线、涉及方、技术细节，像讲故事一样引人入胜"},
        {"heading": "根因分析", "guide": "深入分析根本原因：是架构缺陷？配置问题？还是新攻击面？让读者理解问题本质"},
...
LAW_A = PRTemplate(
    ...
    sections=[
        ...
        {"heading": "应对方案", "guide": "结合亚信安全的产品能力，介绍如何帮助企业满足合规要求，自然引出产品价值"},
...
LAW_B = PRTemplate(
    ...
    sections=[
        ...
        {"heading": "技术应对", "guide": "结合亚信安全的产品技术，介绍如何响应新规要求，展示技术方案的价值"},
...
AI_A = PRTemplate(
    ...
    sections=[
        ...
        {"heading": "核心亮点", "guide": "3-5个核心技术突破点，重点关注与智能体安全相关的特性，用通俗语言解释"},
        {"heading": "安全启示", "guide": "该技术对Agent安全、身份认证、权限管控等领域的影响和启发"},
        {"heading": "产品关联", "guide": "结合亚信安全的产品能力，分析我们可以如何利用或应对该技术，自然引出产品价值"},
...
AI_B = PRTemplate(
    ...
    sections=[
        {"heading": "行业背景", "guide": "该技术/产品所处领域的行业现状和发展趋势，让读者理解大环境"},
        {"heading": "技术拆解", "guide": "技术架构、核心组件、与现有方案的对比，用读者能理解的方式解释"},
        {"heading": "安全挑战", "guide": "该技术带来的新安全风险和现有安全方案的不足，帮助读者认识风险"},
        {"heading": "我们的方案", "guide": "结合亚信安全的产品方案，介绍如何应对这些新安全挑战，展示方案价值"},
