...
BREAKING_A = PRTemplate(
    ...
    sections=[
        {"heading": "事件概述",
         "guide": "2-3句概述事件基本信息：时间、涉及方、事件性质、影响范围"},
        {"heading": "技术分析",
        ...
        {"heading": "行动建议",
         "guide": "产品侧/销售侧/市场侧的具体行动项，3-5条可执行建议"},
        {"heading": "关键词",
         "guide": "3-5个关键词标签"},
    ],
    perspectives=[
...
BREAKING_B = PRTemplate(
    ...
    sections=[
        {"heading": "事件还原",
         "guide": "详细还原事件经过，包括时间线、涉及方、技术细节"},
        {"heading": "根因分析",
         "guide": "深入分析根本原因：是架构缺陷？配置问题？还是新攻击面？"},
        {"heading": "行业影响",
         "guide": "对行业格局、安全标准、监管方向的潜在影响"},
        {"heading": "我们的机会",
         "guide": "结合智能体身份安全产品的切入点，本次事件如何证明产品价值"},
        {"heading": "推荐策略",
         "guide": "短期（1周内）+ 中期（1月内）+ 长期策略建议"},
        {"heading": "关键词",
         "guide": "3-5个关键词标签"},
    ],
    perspectives=[
...
LAW_A = PRTemplate(
    ...
    sections=[
        ...
        {"heading": "合规影响分析",
         "guide": "该法规对企业客户和我们自身产品的合规影响"},
        {"heading": "产品机遇",
         "guide": "我们的产品如何帮助客户满足合规要求，可关联哪些功能模块"},
        {"heading": "行动建议",
         "guide": "产品侧合规改造 + 销售侧合规话术 + 市场侧白皮书/方案"},
        {"heading": "关键词",
         "guide": "3-5个关键词标签"},
    ],
    perspectives=[
...
LAW_B = PRTemplate(
    ...
    sections=[
        {"heading": "政策背景",
         "guide": "国内外政策环境、出台背景、与已有法规的关系"},
        {"heading": "核心变化",
         "guide": "与之前相比，本次法规的最大变化是什么？新要求有哪些？"},
        {"heading": "行业冲击",
         "guide": "对智能体安全行业、客户、友商的短期和长期影响"},
        {"heading": "我们的应对",
         "guide": "产品功能如何满足新规要求？竞品有无先发优势？"},
        {"heading": "时间线建议",
         "guide": "按时间线给出产品、销售、市场的阶段性任务"},
        {"heading": "关键词",
         "guide": "3-5个关键词标签"},
    ],
    perspectives=[
...
AI_A = PRTemplate(
    ...
    sections=[
        ...
        {"heading": "技术亮点",
         "guide": "3-5个核心技术突破点，重点关注与智能体安全相关的特性"},
        {"heading": "安全启示",
         "guide": "该技术对Agent安全、身份认证、权限管控等领域的影响和启发"},
        {"heading": "我们的关联",
         "guide": "结合产品功能矩阵，分析我们可以如何利用或应对该技术"},
        {"heading": "行动建议",
         "guide": "产品集成/技术跟进 + 市场传播 + 客户沟通建议"},
        {"heading": "关键词",
         "guide": "3-5个关键词标签"},
    ],
    perspectives=[
...
AI_B = PRTemplate(
    ...
    sections=[
        {"heading": "行业背景",
         "guide": "该技术/产品所处领域的行业现状和发展趋势"},
        {"heading": "技术拆解",
         "guide": "技术架构、核心组件、与现有方案的对比"},
        {"heading": "安全缺口",
         "guide": "该技术带来的新安全风险和现有安全方案的不足"},
        {"heading": "产品机会",
         "guide": "该技术为智能体身份安全产品带来的市场机会和产品方向"},
        {"heading": "竞品动态",
         "guide": "如有友商在该领域的布局，简要分析竞争态势"},
        {"heading": "战略建议",
         "guide": "我们的短期应对 + 中长期布局建议"},
        {"heading": "关键词",
         "guide": "3-5个关键词标签"},
    ],
    perspectives=[
