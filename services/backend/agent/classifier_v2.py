...
**注意：安全媒体（The Hacker News/BleepingComputer/SecurityWeek 等）**
发布的文章天然属于安全领域，应从 6 类中选择，不应归入"不相关"。
...
### 6. 学术/会展/高校
**仅限纯学术内容**：学术论文发表、安全会议、高校合作、产学研动态。
- 典型特征：顶会论文、学术期刊、安全竞赛、高校实验室成果、培训认证
- 关键词：论文、会议、学术、高校、大学、实验室、竞赛、CCS、
  USENIX、S&P、NDSS、arXiv、Springer、IEEE
- 判断标准：以学术/教育视角为主，非产业落地

**⚠️ 易混淆场景（以下必须归为其他类，绝不能归入"学术/会展/高校"）：**
- 安全媒体（The Hacker News/BleepingComputer 等）报道的漏洞/攻击/恶意软件 → 爆点事件
- 厂商发布的安全研究报告（非学术论文）→ 爆点事件 或 AI技术重大进展
- 安全厂商的技术博客、工具发布 → 国内外竞品信息 或 AI技术重大进展
- 政府/监管机构发布的安全指南 → 法律法规/监管动态
- 安全会议的新闻报道（非论文本身）→ 爆点事件
